...
def main():
    ...
    parser.add_argument('-fp', '--feature_path', type=str, default='/workspace/CTCA/pre_processing/vcdb_rmac_89325_2048.hdf5',
                        help='Path to the kv dataset that contains the features of the train set')

    parser.add_argument('-mp', '--model_path', type=str, default='/mldisk/nfs_shared_/dh/weights/vcdb_rmac_89325_2048_TCA',
    ...
    parser.add_argument('-efp', '--eval_feature_path', type=str, default='/mldisk/nfs_shared_/dh/datasets/fivr/fivr_rmac_187563_2048.hdf5',
